...
public class StockManagerTest {
	...
	public void testAddBook() {
		...
		assertTrue("Invalid ISBN exception should be thrown!", exceptionThrown);
		...
		try {
			...
			assertTrue("The two books are not the same", currentList.get(0)
					.equals(listBooks.get(0)));
			assertTrue("The two lists of books are not the same",
